            ...
            <BrowserRouter>
              ...
              <Routes>
                <Route index element={user === null
                  ? <SignIn onError={setError} onSuccess={refreshToken} to="/" />
                  : <Main><ProjectTable /></Main>
                } />
                <Route path="/sign-up" element={<SignUp onError={setError} onSuccess={refreshToken} to="/" />} />
                <Route path="/sign-in" element={<SignIn onError={setError} onSuccess={refreshToken} to="/" />} />
                <Route path="/project">
