...
import StageGridColumn from "component/project/goal/stage/grid/column";
...
import Type from "model/project/goal/stage/type";
...
export const StageGrid = Component;
export const StageGridContext = Context;
